...
class Gemini:
    ...
    def get_transaction_from_gemini(self, transactions: list[Email]) -> list[Transaction]:
        ...
        prompt = self.prompt.replace("{enumerated_transactions}", str(enumerated_transactions))
